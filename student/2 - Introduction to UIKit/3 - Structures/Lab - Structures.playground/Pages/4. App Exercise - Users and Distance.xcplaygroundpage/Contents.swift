...
var Neeraj = User(name: "Neeraj Sharma", age: 23, height: 70, weight: 163, activityLevel: 2)
print("My name is \(Neeraj.name). I am \(Neeraj.age), weight \(Neeraj.weight) lbs and am \(Neeraj.height) inches tall. On an activity scale from 1-10 I am probably a \(Neeraj.activityLevel).")
/*:
