 ...
 */
struct User {
    static var currentUser: User = User(userName: "neeraj12345", email: "ns98054978@gmail.com", age: 23)
...
let newUser = User(userName: "neeraj12345", email: "ns98054978@gmail.com", age: 23)
